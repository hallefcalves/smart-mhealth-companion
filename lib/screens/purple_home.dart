          ...
          child: ListView(
            children: [
              ...
              const Padding(
                ...
                child: BtnDialog(accentColor, accentColorMedium, 'Bem-vindo ao \n Despertador Deles', 'Você está conectado a Ana Clara!', 'Ana Clara agora pode acompanhar seus tratamentos, facilitar sua vida e ajudar a manter sua boa saúde!','lib/assets/anaclara_prf.png' ),
              ),
                Row(
                    children: const[
                    Padding(
